          ...
          <div className="flex items-center mb-4">
            <div className="flex-1">
              <input
                ...
                className="p-2 border rounded mr-4 focus:outline-none focus:ring-2 focus:ring-blue-500 w-full"
...
// export const Dashboard = () => {
//   const [notificationId, setNotificationId] = useState<number>(1); // Default ID
//   const { report, isLoading, error, refreshReport } = useReport(notificationId);
//   const { logout } = useAuth();
...
//               className="p-2 border rounded mr-4 focus:outline-none focus:ring-2 focus:ring-blue-500"
//               placeholder="Enter Notification ID"
//             />
//             <button
